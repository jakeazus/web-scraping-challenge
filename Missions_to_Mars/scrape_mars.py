...
def mars_scrape():
    ...
    results = soup.find('a', class_="BaseButton")['href']
    ...
    output = {"news_title":news_title,"featured_img":results,"news_p":paragraph_text,"mars_facts":mars_html_table_string,"hemisphere_imgs_url":hemisphere_image_urls}
    return output
